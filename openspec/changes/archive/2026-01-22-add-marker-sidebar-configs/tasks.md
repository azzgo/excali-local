## 1. Implementation
- [x] 1.1 Add stroke width configuration UI and state management
- [x] 1.2 Add corner/roundness configuration UI and state management
- [x] 1.3 Add arrow type configuration UI and state management
- [x] 1.4 Add font family configuration UI and state management
- [x] 1.5 Add font size configuration UI and state management
- [x] 1.6 Add i18n translations for all new labels (en and zh-CN)
- [x] 1.7 Update marker-sidebar.tsx layout with new configuration sections
