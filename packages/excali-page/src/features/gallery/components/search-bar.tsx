...
const SearchBar = ({ onResetPage }: SearchBarProps) => {
  ...
  return (
    <div className="relative">
      <div className="absolute left-2 top-1/2 -translate-y-1/2 text-[var(--color-muted)] pointer-events-none z-10">
      ...
      <Input
        ...
        className={cn(
          ...
          "text-[var(--text-primary-color)] placeholder:text-[var(--color-muted)]",
      ...
      {inputValue && (
        <Button
          variant="ghost"
          size="icon"
          className="absolute right-0 top-0 h-9 w-9 text-[var(--color-muted)] hover:text-[var(--text-primary-color)]"
          onClick={handleClear}
        >
